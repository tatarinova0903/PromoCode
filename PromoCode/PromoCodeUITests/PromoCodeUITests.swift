//
//  PromoCodeUITests.swift
//  PromoCodeUITests
//
//  Created by Дарья on 05.09.2021.
//

import XCTest

class PromoCodeUITests: XCTestCase {
    ...
    func testExample() throws {
        ...
        app.collectionViews.staticTexts["ЯндексЕда"].tap()
        ...
        element.children(matching: .other).element(boundBy: 2).images["heart.fill"].tap()
